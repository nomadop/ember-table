(function($) {
  ...
  $.fn.simulateDragSortable = function(options) {
    ...
    var applyDrag = function(optionsIn) {
      // allow for a drag handle if item is not draggable
      var that = this,
        options = optionsIn || opts, // default to plugin opts unless options explicitly provided
      ...
      if (dropOn) {
        ...
        options = window.jQuery.extend(options, { move: moveCounter });
